...
function f(input) {
    ...
    else if (input[0] === '' || input[1] === '') {return undefined}
    else if (input[0] >= input[1] || input[0] <= input[1]) {return input[0] + input[1]}
}
...
let inputs = [[2, 4], [-3, 3], ['banana', 0], ['', 9], [-1, 3.5], [0, 0], [91, 9]];
let outputs = [6, 0, undefined, undefined, 2.5, 0, 100];
